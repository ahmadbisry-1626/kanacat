    ...
    return (
        <div className='flex items-center gap-2 h-[50px] md:h-full w-full'>
            <div className='flex items-center gap-2 h-full w-full relative'>
                <div className='px-4 rounded-[12px] bg-black h-full md:flex hidden items-center justify-center'>
                ...
                <input
                    ...
                    className={`input md:!text-[18px] font-medium h-full placeholder:md:text-[18px] placeholder:text-gray-400 border-0 max-md:border-[3px] max-md:border-gray-300 rounded-[12px] md:pr-16 pr-10 px-4 w-full bg-transparent`}
                ...
                {query && (
                    <button className='absolute right-2' onClick={() => setIsQuery('')}>
                        <IoIosCloseCircle className='md:size-12 size-8'/>
                    </button>
                )}
            </div>
        </div>
